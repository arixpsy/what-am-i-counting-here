...
export type CounterColor = (typeof CounterColors)[number]
...
export const CounterFormSchema = z.object({
	...
	increment: z.number().min(0, 'Increments should be 0 or more'),
})

export type NewCounterRequest = Omit<NewCounter, 'userId'>